class DealershipsController < ApplicationController
  ...
  private
    ...
    def dealership_params
      params.fetch(:dealership, {}).permit(:name, :phone, :primary_color, :new_cars_url, :used_cars_url, :service_url, :specials_url, :service_specials_url, :parts_url, :financing_url, :sales_email, :service_email, :street, :city, :state, :country, :zipcode, :logo, :background_image, :iframeFriendly, :facebook_url, :twitter_url)
    end
end
